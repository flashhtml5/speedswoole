...
<html lang="cn">
  <head>
    <title>搞啥啊 GSA - 来找好软件好游戏好应用!</title>
    <meta charset="utf-8">
  ...
  <body class="page page-index navbar-layout-default">
    ...
    <a id="#top" href="#content" class="sr-only">skip</a>
        ...
        <div class="header-hidden-inner container">
          <div class="row">
            <div class="col-sm-6">
              ...
              <p>帮助用户快速发现和体验最新最好的软件</p>
              <a href="about.html" class="btn btn-sm btn-primary">查看详情</a>
            </div>
            <div class="col-sm-6">
        ...
        <div class="header-inner container">
          ...
          <div class="header-block-flex order-1 mr-auto">
            <nav class="nav nav-sm header-block-flex">
              ...
              <a class="nav-link text-xs text-uppercase d-none d-md-block" href="#signup-modal" data-toggle="modal">注册</a> <a class="nav-link text-xs text-uppercase d-none d-md-block" href="#login-modal" data-toggle="modal">登陆</a>
            </nav>
            <div class="header-divider header-divider-sm"></div>
            <!--language menu-->
            <div class="dropdown dropdowns-no-carets">
              <a href="#cn" class="dropdown-item lang-cn"><i class="flag-icon flag-icon-cn"></i> 中文</a>
              ...
              <!--<div class="dropdown-menu dropdown-menu-mini dropdown-menu-primary">-->
                <!--&lt;!&ndash;<a href="#es" class="dropdown-item lang-es"><i class="flag-icon flag-icon-es"></i> Spanish</a>&ndash;&gt;-->
                <!--&lt;!&ndash;<a href="#pt" class="dropdown-item lang-pt"><i class="flag-icon flag-icon-pt"></i> Portguese</a>&ndash;&gt;-->
                <!--<a href="#cn" class="dropdown-item lang-cn"><i class="flag-icon flag-icon-cn"></i> 中文</a>-->
                <!--&lt;!&ndash;<a href="#se" class="dropdown-item lang-se"><i class="flag-icon flag-icon-se"></i> Swedish</a>&ndash;&gt;-->
              <!--</div>-->
            </div>
          </div>
          <!--social media icons-->
      ...
      <div data-toggle="sticky">
        ...
        <div class="header-search collapse" id="search">
          <form class="search-form container">
            <input type="text" name="search" class="form-control search" value="" placeholder="搜索内容">
            <button type="button" class="btn btn-link"><span class="sr-only">搜索 </span><i class="fa fa-search fa-flip-horizontal search-icon"></i></button>
          ...
          <div class="header-inner container">
            ...
            <div class="header-brand">
              <a class="header-brand-text" href="index.html" title="Home">
                <h1 class="h2">
                  <span class="header-brand-text-alt">搞啥啊</span>GSA<span class="header-brand-text-alt">.</span>
                </h1>
              </a>
              <div class="header-divider d-none d-lg-block"></div>
              <div class="header-slogan d-none d-lg-block">应用及游戏发现</div>
            </div>
              ...
              <div class="navbar-main collapse">
                ...
                <ul class="nav navbar-nav float-lg-right dropdown-effect-fade">
                    ...
                    <!--<div class="dropdown-menu">-->
                      ...
                      <!--<div class="dropdown dropdown-submenu dropdown-menu-left">-->
                        ...
                        <!--<div class="dropdown-menu">-->
                          ...
                          <!--&lt;!&ndash;Backstretch Slider&ndash;&gt;-->
                          <!--<h4 class="dropdown-header">-->
                            <!--Backstretch-->
                          <!--</h4>-->
                  ...
                  <!--<li class="nav-item dropdown dropdown-mega-menu dropdown-mega-menu-75">-->
                    ...
                    <!--&lt;!&ndash; Dropdown Menu - mega menu&ndash;&gt;-->
                      ...
                      <!--<div class="row">-->
                        ...
                        <!--<div class="col-lg-6 d-none d-lg-block">-->
                          ...
                          <!--<div class="dropdown-widget">-->
                            <!--&lt;!&ndash; Shop product carousel Uses Owl Carousel plugin All options here are customisable from the data-owl-carousel-settings="{OBJECT}" item via data- attributes: http://www.owlgraphic.com/owlcarousel/#customizing ie. data-settings="{"items": "4", "lazyLoad":"true", "navigation":"true"}" &ndash;&gt;-->
...
data-paddingleft="[0,0,0,0]">我们正全力工作!</div>
              <!-- Layer 2 -->
...
data-textAlign="['left','left','left','left']">为您精选最好的游戏和应用!</div>
              <!-- Layer 3 -->
...
<a href="https://wrapbootstrap.com/theme/appstrap-responsive-website-template-WB0C6D0H4?ref=tme" class="btn btn-primary btn-rounded btn-xlg d-none d-md-block">开始探索!</a>
<a href="https://wrapbootstrap.com/theme/appstrap-responsive-website-template-WB0C6D0H4?ref=tme" class="btn btn-primary btn-rounded btn-sm d-md-none">开始探索!</a> </div>
            </li>
          </ul>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 py-5">
              ...
              <h2 class="display-4 text-slab text-white text-uppercase mt-0 mb-5">
                我们的优势 <span class="text-primary font-weight-bold">GameSoftApp</span>
              </h2>
              <div class="row mb-3">
        ...
        <div class="container">
          ...
          <div class="row pricing-stack">
            <div class="col-md-3">
              <div class="card bg-shadow text-center rounded">
                ...
                <p class="price-banner border-grey card-body-overlap"> <span class="text-fancy price-digits">完全免费!</span>
</p>
                <div class="card-body">
                  ...
                  <a href="#" class="btn btn-primary btn-block btn-rounded">马上注册</a>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="card bg-white bg-shadow text-center card-outline-primary">
                ...
                <div class="card-body">
                  ...
                  <a href="#" class="btn btn-primary btn-block btn-rounded mt-4">马上注册</a>
                </div>
              </div>
            </div>
            <div class="col-md-3">
          ...
          <div class="bg-grey bg-shadow py-3 mt-4 text-center">
            <h4 class="d-inline-block pr-1 my-0">
              <span>注意 <span class="font-weight-normal text-muted">以上所有套餐</span>:</span>
            </h4>
            <p class="d-inline-block text-muted my-0">90 天内无条件退款 <span class="text-primary font-weight-bold">//</span> 24/7 电话支持 <span class="text-primary font-weight-bold">//</span> FREE Setup <span class="text-primary font-weight-bold">//</span> Migration Help <span class="text-primary font-weight-bold">//</span> Developer API</p>
          </div>
        </div>
      </div>
      <!-- Steps -->
      <div class="container">
        <div class="py-3 py-lg-6">
          <ul class="nav nav-steps nav-steps-circles flex-column flex-lg-row justify-content-around w-80 mx-auto">
            <li class="nav-item">
              <a href="#tab-steps1" class="nav-link active" data-toggle="tab"> <i class="fa fa-camera-retro icon-2x mb-05"></i> <span class="font-weight-bold d-block">第一步</span> </a>
            </li>
            <li class="nav-item">
              <a href="#tab-steps2" class="nav-link" data-toggle="tab"> <i class="fa fa-thumbs-up icon-2x mb-05"></i> <span class="font-weight-bold d-block">第二步</span> </a>
            </li>
            <li class="nav-item">
              <a href="#tab-steps3" class="nav-link" data-toggle="tab"> <i class="fa fa-rocket icon-2x mb-05"></i> <span class="font-weight-bold d-block">第三步</span> </a>
            </li>
            <li class="nav-item">
              <a href="#tab-steps4" class="nav-link" data-toggle="tab"> <i class="fa fa-flag icon-2x mb-05"></i> <span class="font-weight-bold d-block">第四步</span> </a>
            </li>
          </ul>
          <div class="tab-content text-center pb-2 px-md-6">
            <div class="tab-pane fade active show" id="tab-steps1">
              ...
              <p>第一步第一步第一步第一步第一步第一步第一步第一步第一步第一步第一步第一步第一步第一步第一步第一步第一步.</p>
              <a href="https://wrapbootstrap.com/theme/appstrap-responsive-website-template-WB0C6D0H4?ref=tme" class="btn btn-lg btn-outline-primary">从这里开始</a>
            </div>
      ...
      <div class="p-3 p-lg-5 bg-light text-center" data-bg-video="/i/assets/videos/bubbles.mp4" data-animate="fadeIn">
        <div class="container">
          <h2 class="text-white display-4 text-shadow">
            要不要 <span class="font-italic font-weight-bold">现在</span> 就试一试!
          </h2>
          <a href="https://wrapbootstrap.com/theme/appstrap-responsive-website-template-WB0C6D0H4?ref=tme" class="btn btn-xlg btn-rounded btn-primary mt-4">开始探索!</a>
      ...
      <div id="projects" class="container p-3 py-lg-6" data-toggle="magnific-popup" data-magnific-popup-settings='{"delegate": "a.project", "gallery":{"enabled":true}}'>
        ...
        <div class="mt-4 owl-nav-over owl-nav-over-lg owl-dots-center" data-toggle="owl-carousel" data-owl-carousel-settings='{"responsive":{"0":{"items":1, "nav":false, "dots":true}, "600":{"items":2, "dots":true}, "940":{"items":3, "nav":true, "dots":true}}, "margin":1, "nav":true, "dots":false}'>
          ...
          <a href="/i/assets/img/projects/project-1.jpg" class="project overlay-hover">
            ...
            <span class="overlay-hover-content"> <i class="fa fa-arrow-circle-right icon-3x text-white"></i> <span class="h5 mt-4">查看这个项目</span> </span>
          </a>
          ...
          <div class="row">
            <div class="col-md-4 d-md-flex">
              <blockquote class="blockquote-bubble text-center" data-animate="fadeIn" data-animate-delay="0.1">
                <p class="blockquote-bubble-content bg-white">"太棒了,我太喜欢!!"</p>
            ...
            <div class="col-md-4 d-md-flex">
              <blockquote class="blockquote-bubble text-center" data-animate="fadeIn" data-animate-delay="0.2">
                <p class="blockquote-bubble-content bg-white text-center">"10 out of 10,太棒了,我太喜欢!!"</p>
                <small class="text-grey">
            ...
            <div class="col-md-4 d-md-flex">
              <blockquote class="blockquote-bubble text-center" data-animate="fadeIn" data-animate-delay="0.3">
                <p class="blockquote-bubble-content bg-white text-center">"太棒了,我太喜欢!"</p>
                <small class="text-grey">
          ...
          <div class="row text-center text-lg-left">
            <div class="col-12 col-lg-7 py-2">
              <h2 class="text-uppercase font-weight-bold mt-0 mb-2">
                <span class="text-shadow">特别提示</span> <span class="text-primary-darkend">好东西</span>
              </h2>
              <h5 class="text-faded">
                99.9% 效率提升的秘诀 <span class="text-primary-darkend font-weight-bold px-lg-1">/</span> 开始 <span class="text-primary-darkend font-weight-bold px-lg-1">/</span> Fully Responsive <span class="text-primary-darkend font-weight-bold px-lg-1">/</span> Bug Free
              </h5>
            </div>
            <div class="col-12 col-lg-5 py-2 text-lg-right">
              <a href="https://wrapbootstrap.com/theme/appstrap-responsive-website-template-WB0C6D0H4?ref=tme" class="btn btn-lg btn-primary btn-invert btn-rounded py-3 px-4">点击开始<i class="fa fa-arrow-right ml-2"></i></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <footer id="footer" class="p-0">
          ...
          <div class="col-md-4">
            ...
            <form>
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="email-field" placeholder="电子邮箱">
                <span class="input-group-btn">
                  <button class="btn btn-primary" type="button">订!</button>
                </span>
              </div>
            </form>
          </div>
      ...
      <div class="bg-inverse-dark text-sm py-3">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              <p class="mb-0">Site build by <a href="appstraptheme.com" class="footer-link">GameSoftApp</a> | Copyright 2018 &copy; GameSoftApp.cn </p>
            </div>
            <div class="col-md-6">
